...
$$
P(\text{success}) = \Bigl(\text{sim}_{i,m} + \bar{s}_i\,(1 - \text{sim}_{i,m})\Bigr) \times \frac{\theta_{\text{actual}}}{\theta_{\text{reported}}}
\tag{1}
$$
...
$$
P(\text{debunk success}) = \text{proficiency} \times (1 - \theta_{\text{actual}})
\tag{5}
$$
